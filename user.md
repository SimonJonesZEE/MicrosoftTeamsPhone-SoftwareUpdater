...
> [!IMPORTANT]
> In some instances, the **HealthStatus** of a device may change and show as 'offline' which is common to firmware updates; when this happens, manually reboot the device.
