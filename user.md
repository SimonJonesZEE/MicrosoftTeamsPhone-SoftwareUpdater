...
> [!IMPORTANT]
> In some instances, the **HealthStatus** of a device may change and show as 'offline' which is common when updating firmware; when this happens, manually reboot the device.
