...
You can repeatedly run option **5. Verify software**, which will update the 'did.csv' file in order for you to track the progress of the updates being applied to the devices and for any further step updates.
