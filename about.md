...
Once connected, the 'Tenant Display Name' will change to that of the connected tenant, along with an intuitive menu system.
...
#### 3. Select file 
> This is mapped to the 'data' directory for a *.txt file selection.
#### 4. Analyze file 
